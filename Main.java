...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("The Accord has a top speed of " + accord.topSpeed + "mph, while producing " + accord.torque + " lb-ft of torque and " + accord.hp + " horsepower.");
        ...
        System.out.println("The BMW M5 has a top speed of " + M5.topSpeed + "mph, while producing " + M5.torque + " lb-ft of torque and " + M5.hp + " horsepower.");
        ...
        System.out.println("The Lambourghini Huracan Performante has a top speed of " + huracan.topSpeed + "mph, while producing " + huracan.torque + " lb-ft of torque and " + huracan.hp + " horsepower.");
